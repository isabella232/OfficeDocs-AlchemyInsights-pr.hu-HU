...
---
# <a name="update-dns-records-at-google-enom"></a>DNS-rekordok frissítése a Google-nál (eNom)

Az alábbi hivatkozások segítségével frissítheti DNS-rekordjait.

- [DNS-rekordok létrehozása a Google-nál (eNom](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-for-domain-managed-by-google-enom?view=o365-worldwide)
