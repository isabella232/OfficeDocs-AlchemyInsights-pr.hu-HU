...
---
# <a name="single-sign-on-sso-in-microsoft-edge"></a>Egyszeri bejelentkezés (SSO) a Microsoft Edge-ben

A Microsoft Edge a következő típusú egyszeri bejelentkezést támogatja:
- PRT-alapú SSO
