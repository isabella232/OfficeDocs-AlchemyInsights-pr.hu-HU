...
Mielőtt névjegyeket importál a Outlook.com-ba, exportálnia kell őket a másik e-mail-szolgáltatójából. csv fájlként. Ezután kövesse az alábbi utasításokat.
...
.
2. A lap **tetején válassza a** \> **Névjegyek importálása**lehetőséget.
3. Válassza a **Tallózás**gombot, keresse meg azt a mappát, ahová az exportált névjegyeket mentette, és válassza a **Megnyitás**gombot.

További információt a [Névjegyek importálása az Outlook.com](https://support.office.com/article/285a3b55-8d93-4ac8-93df-43fffd13b2f1?wt.mc_id=Office_Outlook_com_Alchemy)-ba című témakörben talál.
