...
ms.locfileid: "28293035"
---
# <a name="troubleshoot-issues-with-enrolling-macos-devices-in-microsoft-intune"></a>Igénylése a Microsoft Intune macOS-eszközök problémáinak elhárítása
...
3. [Útmutató a Microsoft Intune macOS eszközök igénylésére](https://docs.microsoft.com/en-us/intune/macos-enroll).
    
[Végfelhasználói kézikönyv macOS eszköz a Microsoft Intune igényléséhez kivétele](https://docs.microsoft.com/en-us/intune-user-help/enroll-your-device-in-intune-macos-cp)
