---
title: Alkímia inekbvonalas képek tesztelése
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "44505057"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="84931-102">A Tartományok lap elérése</span><span class="sxs-lookup"><span data-stu-id="84931-102">Access the Domains Page</span></span>

<span data-ttu-id="84931-103">A tartományok oldalának eléréséhez kattintson az alábbi ikonra:</span><span class="sxs-lookup"><span data-stu-id="84931-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="84931-104">Ezután hozzáadhatja, módosíthatja vagy eltávolíthatja a tartományt.</span><span class="sxs-lookup"><span data-stu-id="84931-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="84931-105">További információt a [Tartományok gyakori kérdések című témakörben talál.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="84931-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
