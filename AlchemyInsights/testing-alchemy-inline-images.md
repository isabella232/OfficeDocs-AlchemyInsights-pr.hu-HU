...
ms.locfileid: "36507165"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="e7a38-102">Hozzáférés a tartományok lap</span><span class="sxs-lookup"><span data-stu-id="e7a38-102">Access the Domains Page</span></span>

<span data-ttu-id="e7a38-103">A tartományok lap eléréséhez kattintson az alábbi ikonra:</span><span class="sxs-lookup"><span data-stu-id="e7a38-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="e7a38-104">Majd hozzáadása, módosítása, és távolítsa el a tartományt.</span><span class="sxs-lookup"><span data-stu-id="e7a38-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="e7a38-105">További tudnivalókért tanulmányozza a [tartományok GYIK.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span><span class="sxs-lookup"><span data-stu-id="e7a38-105">For more information, see the [Domains FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span></span>
