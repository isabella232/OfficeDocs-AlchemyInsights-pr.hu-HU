...
---
# <a name="access-the-domains-page"></a>A Domains (tartományok) lap elérése

A Domains (tartományok) lap eléréséhez csak kattintson erre az ikonra:
...
Ezután megadhatja, módosíthatja vagy eltávolíthatja a tartományát.
További információt a [tartományok – gyakori kérdések](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq) című témakörben talál.
