...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="173e0-102">Hozzáférés a tartományok laphoz</span><span class="sxs-lookup"><span data-stu-id="173e0-102">Access the Domains Page</span></span>

<span data-ttu-id="173e0-103">-Hoz belépés a domínumok oldal, csak kettyenés ez ikon alul:</span><span class="sxs-lookup"><span data-stu-id="173e0-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="173e0-104">Ezután hozzáadhatja, módosíthatja vagy eltávolíthatja a tartományt.</span><span class="sxs-lookup"><span data-stu-id="173e0-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="173e0-105">További információt a [tartományok – GYIK](https://docs.microsoft.com/office365/admin/setup/domains-faq) című témakörben talál.</span><span class="sxs-lookup"><span data-stu-id="173e0-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
